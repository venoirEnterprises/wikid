...
const authCheck = jwt({
	secret: jwks.expressJwtSecret({
		...
		jwksUri: 'https://wikid.auth0.com/.well-known/jwks.json' // @TODO: remove domain name
	}),
	audience: 'http://localhost:3001',
	issuer: 'https://wikid.auth0.com/', // @TODO: remove domain name
	algorithms: [ 'RS256' ]
});
...
app.get('/api/deals/public', (req, res) => {
	let deals = [
		...
		},
		{
			...
			name: 'GoPro 4',
			description:
				'Record yourself in first person 24/7 with the GoPro 4. Show everyone how exciting your life is.',
